# Four-functional bottlebrushes: bulk
...
```bash
bash simulations/05_bottlebrush_4functional/bulk/run.sh
```

The generator writes `bottlebrush_4functional_bulk/`. Submit its LAMMPS input, verify the target
