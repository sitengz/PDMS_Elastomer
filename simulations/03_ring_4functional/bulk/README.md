...
```bash
bash simulations/03_ring_4functional/bulk/run.sh
```

The generator writes `ring_4functional_bulk/`. Submit its LAMMPS input, verify the target
