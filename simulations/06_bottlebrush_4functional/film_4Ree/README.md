# Four-functional bottlebrushes: 4Ree film
...
BULK_REE_ANGSTROM=42.5 \
  bash simulations/06_bottlebrush_4functional/film_4Ree/run.sh
```

The runner validates `Ree_bulk`, calculates `H`, and passes it through
`--thickness`. The generator writes `bottlebrush_4functional_film_4Ree/`.
