...
This production case uses 750 equal-arm stars with one neutral center bead and
four functional 40-bead arms. Each precursor contains 161 beads. The deliberate
0.52% total-bead excess preserves equal arm lengths and simplifies analysis.
